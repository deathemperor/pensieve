...
echo "2. For PLANS: write a SEPARATE diary entry per plan with entry_type='ultraplan' (for ultraplan sessions) or 'plan' (for local planning). The plan details go in the 'summary' field (full text, preserve structure). These are critical decision records."
